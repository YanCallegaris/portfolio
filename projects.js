const projects = {
  ...
  zombie: {
    image: 'images/projects/zombie.jpg', video: 'https://www.youtube.com/embed/QPnMC0v4kpc',
    en: { title: 'Zombie Shooter Prototype', tag: 'COMBAT · ENEMY BEHAVIOR · SURVIVAL', intro: 'A fast combat prototype built around enemy pressure and moment-to-moment survival.', body: 'The project focuses on shooting, movement, readable feedback and rapid gameplay iteration inside Unity.', points: ['Combat-focused gameplay loop', 'Enemy chase and pressure', 'Fast prototype iteration'] },
