const portfolioTranslations = {
  en: {
    ...
    heroBody: 'I build gameplay systems, interactive features and polished UI flows in Unity — from production educational games to focused personal prototypes.',
  ...
  pt: {
    ...
    heroBody: 'Desenvolvo sistemas de gameplay, recursos interativos e fluxos de UI refinados em Unity — de jogos educacionais em produção a protótipos pessoais focados.',
